...
template<typename R , typename T1, typename Allocator, size_t t_countof_pvoid>
struct delegateImpl1 : private detail::allocator_base<Allocator>
{
  typedef delegateImpl1<R , T1, Allocator, t_countof_pvoid> thisClass;
  ...
  //
  typedef result_type (*stub_type)(thisClass const &, void * , T1);
  typedef result_type (*stub_const_type)(thisClass const &, void const * , T1);
  ...
  // *** No heap allocation ****
  //
  template<typename UR , typename U1>
  struct fp_by_value
  {
    // DefaultVoid - a workaround for 'void' templates in VC6.
    ...
    struct callee_spec_
    {
      ...
      //
      template<typename U>
        static void init_(thisClass & dg, UR (U::*mfn)(U1))
      {
      ...
      template<typename U>
        static inline void init_(thisClass & dg, UR (U::*mfn)(U1) const)
      {
        typedef UR (U::*TMFn)(U1) const;
      ...
      //
      template<typename U>
        static inline result_type2 (U::* const get_fp_(thisClass const & dg, U *))(U1)
      {
        typedef result_type2 (U::*TMFn)(U1);
        return *reinterpret_cast<TMFn const *>(dg.buf_);
      }

      template<typename U>
        static inline result_type2 (U::* const get_const_fp_(thisClass const & dg, U const *))(U1) const
      {
        typedef result_type2 (U::*TMFn)(U1) const;
        return *reinterpret_cast<TMFn const *>(dg.buf_);
      }
      ...
      //
      template<typename U>
        static inline result_type2 invoke_(thisClass const & dg, U * obj , U1 q1)
      {
        if(0 == obj)
        {
      ...
      template<typename U>
        static inline result_type2 invoke_const_(thisClass const & dg, U const * obj , U1 q1)
      {
        if(0 == obj)
        {
          // member function call on no object
      ...
      struct mfn_adapter_
      {
        ...
        //
        template<typename U>
          static inline void init_(thisClass & dg, UR (U::*mfn)())
        {
          typedef UR (U::*TMFn)();
        ...
        template<typename U>
          static inline void init_(thisClass & dg, UR (U::*mfn)() const)
        {
          typedef UR (U::*TMFn)() const;
        ...
        //
        template<typename U>
          static inline result_type2 (U::* const get_fp_(thisClass const & dg, U *))()
        {
          typedef result_type2 (U::*TMFn)();
          return *reinterpret_cast<TMFn const *>(dg.buf_);
        }

        template<typename U>
          static inline result_type2 (U::* const get_const_fp_(thisClass const & dg, U const *))() const
        {
          typedef result_type2 (U::*TMFn)() const;
          return *reinterpret_cast<TMFn const *>(dg.buf_);
        }
        ...
        //
        template<typename U>
          static inline result_type2 invoke_(thisClass const & dg, U * obj  )
        {
          if(0 == obj)
          {
            // member function call on no object
        ...
        template<typename U>
          static inline result_type2 invoke_const_(thisClass const & dg, U const * obj  )
        {
          if(0 == obj)
          {
            // member function call on no object
    ...
    struct callee_spec_<free_fn_tag >
    {
      ...
      // init_()
      //
      static inline void init_(thisClass & dg, UR (*fn)(U1))
      {
        typedef UR (*TFn)(U1);
      ...
      // get_fp_()
      //
      static inline result_type2 (* const get_fp_(thisClass const & dg))(U1)
      {
        typedef result_type2 (*TFn)(U1);
  ...
  struct fp_by_malloc
  {
    ...
    struct callee_spec_
    {
      ...
      //
      template<typename U>
        static inline void init_(thisClass & dg, UR (U::*mfn)(U1))
      {
        typedef UR (U::*TMFn)(U1);
  ...
  struct select_fp_
  {
    ...
    struct callee_bind_spec_
    {
      ...
      struct bind_spec_<false >
      {
        struct normal_
        {
          ...
          enum { Condition = sizeof(UR (U::*)(U1)) <= size_buf };

          typedef typename fp_by_value<UR , U1>::template callee_spec_<U>   Then;
          typedef typename fp_by_malloc<UR , U1>::template callee_spec_<U>  Else;
        ...
        struct mfn_adapter_
        {
          ...
          // if the size of the member function is smaller than buffer size use buffer to store it,
          // otherwise use ::malloc to store it on the heap
          enum { Condition = sizeof(UR (U::*)()) <= size_buf };

          typedef typename fp_by_value<UR , U1>::template callee_spec_<U>::mfn_adapter_   Then;
          typedef typename fp_by_malloc<UR , U1>::template callee_spec_<U>::mfn_adapter_  Else;
    ...
    {
      typedef typename fp_by_value<UR , U1>::template callee_spec_<free_fn_tag> type;
  ...
  struct fp_selector_
  {
    ...
    struct callee_bind_spec_
    {
      ...
      struct bind_spec_<true >
      {
        ...
        static inline void init_(thisClass & dg, UR (U::*mfn)(U1))
        {
          select_fp_<UR , U1>::template callee_bind_spec_<U, true>::type::init_(dg, mfn);
        }
        template<typename U>
        static inline void init_(thisClass & dg, UR (U::*mfn)(U1) const)
        {
        ...
        static inline result_type2 invoke_(thisClass const & dg, U * obj , U1 q1)
        {
          return select_fp_<UR , U1>::template callee_bind_spec_<U, true>::type::invoke_(dg, obj , q1);
        }
        template<typename U>
        static inline result_type2 invoke_const_(thisClass const & dg, U const * obj , U1 q1)
        {
          return select_fp_<UR , U1>::template callee_bind_spec_<U, true>::type::invoke_const_(dg, obj , q1);
        }
      ...
      struct bind_spec_<false >
      {
        ...
        static inline void init_(thisClass & dg, UR (U::*mfn)())
        {
          select_fp_<UR , U1>::template callee_bind_spec_<U, false>::type::init_(dg, mfn);
        }
        template<typename U>
        static inline void init_(thisClass & dg, UR (U::*mfn)() const)
        {
        ...
        static inline result_type2 invoke_(thisClass const & dg, U * obj  )
        {
          return select_fp_<UR , U1>::template callee_bind_spec_<U, false>::type::invoke_(dg, obj  );
        }
        template<typename U>
        static inline result_type2 invoke_const_(thisClass const & dg, U const * obj  )
        {
          return select_fp_<UR , U1>::template callee_bind_spec_<U, false>::type::invoke_const_(dg, obj  );
        }
    ...
    struct callee_bind_spec_<free_fn_tag, false >
    {
      static inline void init_(thisClass & dg, UR (*fn)(U1))
      {
        select_fp_<UR , U1>::template callee_bind_spec_<free_fn_tag, false>::type::init_(dg, fn);
      }

      template<typename U>
        static inline result_type2 invoke_(thisClass const & dg, U * obj , U1 q1)
      {
        return select_fp_<UR , U1>::template callee_bind_spec_<free_fn_tag, false>::type::invoke_(dg, obj , q1);
      }
  ...
  struct delegate_stub_t
  {
    ...
    struct callee_bind_spec_
    {
      ...
      //
      // ====================================================================================================
      static inline result_type typed_invoker_(thisClass const & dg, void * untyped_obj , T1 p1)
      {
        ...
        return select_stub_::type::invoke_(dg, typed_obj , p1);
      }

      static inline result_type typed_invoker_const_(thisClass const & dg, void const * untyped_const_obj , T1 p1)
      {
        ...
        // if FD_ENABLE_TYPE_RELAXATION is defined, all warnings/errors message will be issued here
        // to indicate that type can be trivially converted by the compiler
        return select_stub_::type::invoke_const_(dg, typed_const_obj , p1);
      }
      // ====================================================================================================
      //
      // ====================================================================================================
      ...
      struct select_stub_
      {
        ...
        struct bind_spec_<false >
        {
          static inline result_type2 invoke_(thisClass const & dg, U * typed_obj , U1 q1)
          {
            return fp_selector_<UR , U1>::template callee_bind_spec_<U, false>::type::invoke_(dg, typed_obj , q1);
          }

          static inline result_type2 invoke_const_(thisClass const & dg, U const * typed_obj , U1 q1)
          {
            return fp_selector_<UR , U1>::template callee_bind_spec_<U, false>::type::invoke_const_(dg, typed_obj , q1);
          }
          ...
          struct mfn_ptr_adapter_
          {
            ...
            {
              U * typed_obj = q1;
              return fp_selector_<UR , U1>::template callee_bind_spec_<U, false>::type::invoke_(dg, typed_obj  );
            }
            ...
            static inline result_type2 invoke_const_(thisClass const & dg, U const * /*typed_obj*/, U1 q1)
            {
              ...
              return fp_selector_<UR , U1>::template callee_bind_spec_<U, false>::type::invoke_const_(dg, typed_obj  );
            }
        ...
        struct bind_spec_<true >
        {
          static inline result_type2 invoke_(thisClass const & dg, U * typed_obj , U1 q1)
          {
            return fp_selector_<UR , U1>::template callee_bind_spec_<U, true>::type::invoke_(dg, typed_obj , q1);
          }

          static inline result_type2 invoke_const_(thisClass const & dg, U const * typed_obj , U1 q1)
          {
            return fp_selector_<UR , U1>::template callee_bind_spec_<U, true>::type::invoke_const_(dg, typed_obj , q1);
          }
  ...
  // default c'tor
  //
  delegateImpl1() : stub_ptr_(0), obj_ptr_(0)
  ...
  // copy c'tor
  //
  delegateImpl1(thisClass const & other)
  ...
  template<typename UR , typename U1, typename U, typename T>
    delegateImpl1(UR (U::*mfn)(U1), T & obj)
  ...
  template<typename UR , typename U1, typename U, typename T>
    delegateImpl1(UR (U::*mfn)(U1) const, T const & obj)
  ...
  // copy c'tor
  // specialization for member function call adapter
  template<typename UR  , typename U>
    delegateImpl1(UR (U::*mfn)())
    : stub_ptr_(0), obj_ptr_(0)
  ...
  template<typename UR , typename U1>
    inline thisClass & assign_(UR (*fn)(U1), bool reset = true)
  {
    typedef UR (*TFn)(U1);
    // size of free function pointer is smaller than size_buf
    ...
    fp_selector_<UR , U1>::template callee_bind_spec_<free_fn_tag, bind_spec>::init_(*this, fn);
    stub_ptr_ = &delegate_stub_t<UR , U1>::template callee_bind_spec_<free_fn_tag, bind_spec>::typed_invoker_;
  ...
  // specialization for member function call adapter
  template<typename UR  , typename U>
    inline thisClass & assign_(UR (U::*mfn)(), bool reset = true)
  {
    if(reset) reset_();

    enum { bind_spec = false };

    fp_selector_<UR, T1  >::template callee_bind_spec_<U, bind_spec>::type::init_(*this, mfn);
    stub_ptr_ = &delegate_stub_t<UR, T1  >::template callee_bind_spec_<U, bind_spec>::typed_invoker_;

    return *this;
  }

  template<typename UR  , typename U>
    inline thisClass & assign_(UR (U::*mfn)() const, bool reset = true)
  {
    if(reset) reset_();
    ...
    fp_selector_<UR, T1  >::template callee_bind_spec_<U, bind_spec>::type::init_(*this, mfn);
    stub_ptr_ = reinterpret_cast<stub_type>(&delegate_stub_t<UR, T1  >::template callee_bind_spec_<U, bind_spec>::typed_invoker_const_);
  ...
  template<typename UR , typename U1, typename U, typename T>
    inline thisClass & bind_obj_cloned_(UR (U::*mfn)(U1), T & obj, bool reset = true)
  {
    if(reset) reset_();

    enum { bind_spec = true };

    fp_selector_<UR , U1>::template callee_bind_spec_<U, bind_spec>::type::init_(*this, mfn);
    stub_ptr_ = &delegate_stub_t<UR , U1>::template callee_bind_spec_<U, bind_spec>::typed_invoker_;
  ...
  template<typename UR , typename U1, typename U, typename T>
    inline thisClass & bind_obj_cloned_(UR (U::*mfn)(U1) const, T const & obj, bool reset = true)
  {
    if(reset) reset_();
    ...
    fp_selector_<UR , U1>::template callee_bind_spec_<U, bind_spec>::type::init_(*this, mfn);
    stub_ptr_ = reinterpret_cast<stub_type>(&delegate_stub_t<UR , U1>::template callee_bind_spec_<U, bind_spec>::typed_invoker_const_);
  ...
  template<typename UR , typename U1, typename U, typename T>
    inline thisClass & bind_obj_ptr_(UR (U::*mfn)(U1), T * obj, bool reset = true)
  {
    if(reset) reset_();
  ...
  template<typename UR , typename U1, typename U, typename T>
    inline thisClass & bind_obj_ptr_(UR (U::*mfn)(U1) const, T const * obj, bool reset = true)
  {
    if(reset) reset_();
  ...
  //
  inline result_type operator () (T1 p1) const
  {
    if(empty_())
    ...
    if(((void *)-1) == obj_ptr_)
    {
      ...
      return (*stub_ptr_)(*this, ((void *)-1) , p1);
    ...
    else
    {
      if(!fp_info_.is_const)
      {
        ...
        return (*stub_ptr_)(*this, obj_ptr_ , p1);
      }
      else
      {
        ...
        return (*stub_const_ptr)(*this, obj_const_ptr , p1);
      }
    }
  }
...
//
// ====================================================================================================
template<typename R , typename T1, typename Allocator = std::allocator<void> , size_t t_countof_pvoid = DefaultCountOfVoid>
class delegate1
  : public detail::safe_bool<delegate1<R , T1, Allocator, t_countof_pvoid> >
{
  typedef delegate1<R , T1, Allocator, t_countof_pvoid> thisClass;
...
private:
  ...
  typedef detail::delegateImpl1<R , T1, Allocator, t_countof_pvoid> implClass;
  implClass impl_;
...
public:
  ...
  {
    static implClass &
      impl_of_(delegate1<R , T1, Allocator, t_countof_pvoid> & friend_delegate)
    {
      return friend_delegate.impl_;
    }
    static const implClass &
      impl_of_(delegate1<R , T1, Allocator, t_countof_pvoid> const & friend_delegate)
    {
      return friend_delegate.impl_;
    }
...
public:
  ...
  //
  delegate1(typename implClass::clear_type const *)
    : impl_()
  {
  }

  // copy c'tor
  delegate1(thisClass const & other)
    : impl_(other.impl_)
  {
  }
  ...
  template<typename UR , typename U1, typename U, typename T>
    delegate1(UR (U::*mfn)(U1) const, T & obj)
  ...
  template<typename F>
    delegate1(F & functor, bool/* dummy*/)
    : impl_()
  {
...
public:
  ...
  template<typename UR , typename U1>
    inline thisClass & operator = (UR (*fn)(U1))
  {
  ...
  template<typename UR  , typename U>
    inline thisClass & operator = (UR (U::*mfn)())
  ...
  template<typename UR  , typename U>
    inline thisClass & operator = (UR (U::*mfn)() const)
  ...
  template<typename UR , typename U1, typename U, typename T>
    inline thisClass & bind(UR (U::*mfn)(U1 q1), T & obj)
  ...
  template<typename UR , typename U1, typename U, typename T>
    inline thisClass & bind(UR (U::*mfn)(U1 q1) const, T & obj)
...
delegate1<R , T1>
make_delegate(R (*fn)(T1))
{
  return delegate1<R , T1>(fn);
}
...
template<typename R , typename T1, typename U, typename T> inline
delegate1<R , T1>
make_delegate(R (U::*mfn)(T1 p1), T & obj)
{
  // to prevent non-const member function call on const object
  U * param_chk = detail::select_obj_type_<T, U>::type::get_pointer_(obj); param_chk;

  return delegate1<R , T1>(mfn, obj);
}

template<typename R , typename T1, typename U, typename T> inline
delegate1<R , T1>
make_delegate(R (U::*mfn)(T1 p1) const, T & obj)
{
  // to prevent non-const member function call on const object
  U const * param_chk = detail::select_obj_type_<T, U>::type::get_pointer_(obj); param_chk;
...
make_delegate(R (U::*mfn)(T1 p1), T * obj)
{
  ...
  return delegate1<R , T1>(mfn, get_pointer(obj));
}
...
delegate1<R, T *  >
make_delegate(T *, R (U::*mfn)())
{
  // to prevent non-const member function call on const object
  U * param_chk = (T *)0; param_chk;

  return delegate1<R, T *  >(mfn);
}

template<typename R  , typename U, typename T> inline
delegate1<R, T *  >
make_delegate(T *, R (U::*mfn)() const)
{
